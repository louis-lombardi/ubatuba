class GptController < ApplicationController
    ...
    def prescript
        ...
        **********
        ...
        If the contrary (the customer does not want to go to france and exeprience something about wine), summarize the proposal by detailing the request's key points, ask for permission to send the request, gather the user’s email and/or phone number, and ask their preferred response channel.  If they refuse to provide contact information, explain why it’s necessary to fulfill their request but reassure them that you remain available whenever they wish. In this summary, please use HTML tags to organize the bullet points and highlight the main pieces of information. This summary should only appear once, at the end of the conversation.
        Once you have gathered the email address, say exactly \"ENDING_CHAT\" as this will be used as a trigger.
